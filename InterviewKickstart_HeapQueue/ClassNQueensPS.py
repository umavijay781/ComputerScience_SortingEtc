class ClassNQueensPS(object):
    ...
    #   This class is __NOT__ needed.  The SD class (Subproblem Definition)
    #      can also be used as the PS class (but with a separate instantiation). 
    #
    #    ----3/17/2020 Thomas Downes 
    #
    ...
    #def setColumnChoice(self, i_row, k_column):
    #    self.RowIndex = i_row
